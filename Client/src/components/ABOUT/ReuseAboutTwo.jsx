...
function ReuseAboutTwo({ userLoggedIn, sectionId }) {
  ...
  const confirmDelete = async () => {
    try {
      ...
      setImages(""); // Remove the image from state
  ...
  return (
    <>
      ...
      <div ref={aboutRef} className="about-containerTwo">
        {userLoggedIn && (
